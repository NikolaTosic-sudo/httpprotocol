...
func TestRequestLineParse(t *testing.T) {
	...
	_, err = RequestFromReader(strings.NewReader("/coffee GET HTTP/1.2\r\nHost: localhost:42069\r\nUser-Agent: curl/7.81.0\r\nAccept: */*\r\n\r\n"))
	require.Error(t, err)

	// Test: Invalid method (lowercase) in Request line
	_, err = RequestFromReader(strings.NewReader("/coffee get HTTP/1.2\r\nHost: localhost:42069\r\nUser-Agent: curl/7.81.0\r\nAccept: */*\r\n\r\n"))
	require.Error(t, err)

	// Test: Invalid method (parts lowercase) in Request line
	_, err = RequestFromReader(strings.NewReader("/coffee GEt HTTP/1.2\r\nHost: localhost:42069\r\nUser-Agent: curl/7.81.0\r\nAccept: */*\r\n\r\n"))
	require.Error(t, err)
